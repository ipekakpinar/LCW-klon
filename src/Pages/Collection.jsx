    ...
    <div className="flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t">
      ...
      <div className="min-w-52">
        ...
        <div
          className={`border border-gray-300 pl-5 py-3 my-5 ${
            ...
            sm:block`}
        >
          <p className="mb-3 text-sm font-medium">ÜRÜNLER</p>
      ...
      <div className="flex-1">
        ...
        <div className="flex justify-between text-sm sm:text-xl lg:text-2xl mb-4">
          <Title text1={'YAZ'} text2={'KOLEKSİYONU'} />
          ...
          >
            <option value="relevent">Önerilen Sıralama</option>
            <option value="low-high">Ucuzdan Pahalıya</option>
            <option value="high-low">Pahalıdan Ucuza</option>
          </select>
        </div>
